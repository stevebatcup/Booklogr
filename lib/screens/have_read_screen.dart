...
class HaveReadScreen extends StatelessWidget {
  static String pageRoute = '/have-read';
  ...
  Widget build(BuildContext context) {
    ...
    Widget appBar = isMobile
        ...
        : AppBarDesktopTablet(activeSection: NavBarSection.haveRead);

    return ResponsiveBuilder(
      builder: (context, sizingInformation) {
        if (loggedIn) {
          BooksCollection<HaveReadBook> collection =
              BooksCollection<HaveReadBook>()..initUserCollection(user);

          return Scaffold(
            backgroundColor: Theme.of(context).colorScheme.background,
            appBar: appBar,
            body: CentredView(
              child: Consumer<List<HaveReadBook>>(
          ...
          return Scaffold(
            ...
            body: CentredView(
              child: EmptyListAction(
                ...
                label:
                    "Sign up to Booklogr to add books to your ALREADY READ list",
                onTap: () {
                  isMobile
